...
class StationForm(ModelForm):
    class Meta:
        ...
        fields = ['name', 'category', 'address',
                  'supervisor', 'phone', 'email', 'gis_location', 'date_created']
        widgets = {
            ...
            'gis_location': forms.NumberInput(attrs={'class': 'form-control'}),
...
class PatientForm(ModelForm):
    class Meta:
        model = Patient
        fields = ['name', 'gender', 'age', 'address', 'opening_date']
        widgets = {
            'name': forms.TextInput(attrs={'class': 'form-control'}),
...
class DianosisForm(ModelForm):
    class Meta:
        ...
        fields = ['mode_of_diagnosis', 'dianosis_type', 'results',
                  'malaria_type', 'parasitemia_load', 'comment', 'date_created']
        widgets = {
...
class MorbidityForm(ModelForm):
    class Meta:
        model = Morbidity
        fields = ['severity', 'mode_of_admission', 'comment', 'date_created']
        widgets = {
...
class TreatmentForm(ModelForm):
    class Meta:
        model = Treatment
        fields = ['treatment_type', 'treatment_period', 'follow_up',  'further_treatment', 'comment', 'date_created']
        widgets = {
...
class CampReportForm(ModelForm):
    class Meta:
        model = CampReport
        fields = ['screened', 'treated', 'referral', 'date_created']
        widgets = {
